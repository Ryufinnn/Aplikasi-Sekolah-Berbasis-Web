...
<div align="center"><span class="style1"> LOKASI MANDRASAH TSANAWIYAH NEGERI (MTsN) DI KABUPATEN PIDIE </span></div>
<form method="post">
  <select  name="search" size="1" id="search" style="width:70px; height:20px;" value="search"/>                        
              <option value="mtsn">MTSN</option>
            </select>
	<input type="submit"  name="submit" value="Tampilkan Data Peta Lokasi MTsN" />
</form>
</div>
<div id="map">  
</div> 
