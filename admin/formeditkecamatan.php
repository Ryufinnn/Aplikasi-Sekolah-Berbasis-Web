...
$query = "SELECT * FROM kecamatan WHERE kdkec ='$kdkec'";
...
<div id="areaku3">
<form name="postform" id="form1" method="post" action="index.php?page=proseseditkecamatan">
<input type="hidden" name="kdkec" value="<?php echo $h['kdkec']; ?>">
	  ...
	  <table width="1099" border="0">
        ...
        <tr> 
		  ...
		  <td width="7">:</td>
          <td width="928" colspan="3"><input name="kdkec" type="text" disabled="disabled"  class="textfield" id="kdkec" value="<?php echo $h['kdkec']; ?>" size="6"  maxlength="6" /></td>
        </tr>
        <tr> 
          <td>Nama Kecamatan </td>
		  <td width="7">: </td>
          <td><input  name="nmkec" type="text" id="nmkec" value="<?php echo $h['nmkec']; ?>"  size="40" maxlength="67" onKeyPress="return goodchars(event,'a bcdefghijklmnopqrsvxywtuzABCDEFGHIJKLMNOPQRSVXYWUTZ',this)" />        
        </tr>
   ...
   <input type="reset" name="bersih" value="Batal" class="button" onclick="window.location='index.php?page=formkecamatan'"/>    </td>
        </tr>
    </table>
