...
$sql = mysql_query("select * FROM lokasi_sekolah, kecamatan, desa where lokasi_sekolah.kdkec=kecamatan.kdkec and lokasi_sekolah.kddes=desa.kddes and nmkec = '$_POST[nmkec]'");
...
$pdf->setFont('Times','b',14);
$pdf->setXY(130,28); $pdf->cell(35,6,'KECAMATAN');$pdf->cell(20,6,':
'.$data[nmkec]);
...
$pdf->setFont('Times','',14);
	$pdf->line(7, 34,300, 34);
	$pdf->line(7, 39,300, 39);
...
$pdf->Output('Laporan Per Kecamatan.pdf', I);
